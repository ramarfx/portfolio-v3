  ...
  return (
    <>
      <div className="pointer-events-none absolute left-0 top-8 -translate-x-2/4 rotate-180 -scale-x-100 opacity-50 blur-3xl">
        <img src="/shape.svg" className="scale-125" alt="backlight" />
      </div>
